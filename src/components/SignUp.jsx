...
function Signup() {
    ...
    const days = Array.from({ length: 31 }, (_, i) => ({ name: `${i + 1}`, value: i + 1 }));
            ...
            <div className="w-1/2 bg-white flex items-center justify-center p-8">
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <Dropdown
                                    ...
                                    className="w-full"
                                    pt={{
                                        root: { className: "bg-gray-100 border-0 rounded-lg" },
                        ...
                        <button
                            type="submit"
                            className="w-full bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition duration-200 mt-6 cursor-pointer"
                        >
                            Sign up
                        </button>
